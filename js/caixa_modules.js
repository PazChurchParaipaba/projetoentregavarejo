    ...
    injectStyles: () => {
        ...
        style.innerHTML = `
            ...
            .caixa-panel { 
                ...
                height: calc(100vh - 100px); /* Ocupa a tela quase toda */
                display: flex;
            ...
            @media (max-width: 900px) {
                .caixa-panel > div[style*="display: grid"] {
            ...
            <div class="caixa-panel">
                <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid #eee; padding-bottom:15px; margin-bottom:15px;">
                    ...
                    <div style="display:flex; gap:5px;">
                        ...
                        <button class="btn btn-secondary btn-sm" onclick="document.body.classList.remove('caixa-open'); App.router.go('loja')">Voltar</button>
                    </div>
                </div>

                <div class="grid grid-4" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
                    <div class="stat-box">
                        <h5>Fundo Inicial</h5>
                    ...
                    <div class="stat-box" style="background: rgba(239, 68, 68, 0.05) !important;">
                ...
                <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 20px; margin-top: 25px;">
                    ...
                    <div style="background: rgba(0,0,0,0.1); padding: 15px; border-radius: 10px; border: 1px solid rgba(255,255,255,0.05);">
                        ...
                        <div style="display:flex; gap:10px; align-items:flex-end; flex-wrap: wrap;">
                            <div class="input-wrapper" style="flex:2; min-width: 180px; margin:0;">
                                <label class="text-xs">Descrição</label>
                                <input type="text" id="mov-desc" class="input-field" placeholder="Ex: Material Limpeza">
                            </div>
                            <div class="input-wrapper" style="flex:1; min-width: 90px; margin:0;">
                                <label class="text-xs">Valor</label>
                                <input type="number" id="mov-val" class="input-field">
                            </div>
                            <div id="method-select-container" class="input-wrapper" style="flex:1; min-width: 120px; margin:0; display:none;">
                            ...
                            <button id="btn-save-mov" class="btn btn-warning btn-sm" onclick="Caixa.saveMovement()" style="height:52px; width:auto;">Lançar</button>
                            <button id="btn-cancel-mov" class="btn btn-secondary btn-sm" style="display:none; height:52px;" onclick="Caixa.cancelEdit()">X</button>
                        </div>
                        <div id="movements-list" style="margin-top:15px; max-height:180px; overflow-y:auto; border:1px dashed rgba(255,255,255,0.1); padding:10px; border-radius: 8px;"></div>
                    </div>

                    <!-- COLUNA DIREITA: FECHAMENTO -->
                    <div style="background: rgba(239, 68, 68, 0.05); padding: 15px; border-radius: 10px; border: 1px solid rgba(239, 68, 68, 0.2);">
                        <h4 style="margin-top:0; color:#ef4444;"><i class="ri-lock-password-line"></i> Fechamento</h4>
                        
                        <div class="input-wrapper" style="margin-bottom:15px;">
                            <label class="text-xs">Valor em Gaveta (Contagem Física)</label>
                            <input type="number" id="caixa-end-val" class="input-field" placeholder="Dinheiro em mãos" style="border-color: rgba(239, 68, 68, 0.3);">
                        </div>
                        
                        <div style="display:grid; grid-template-columns: 1fr; gap:10px;">
                            <button class="btn btn-danger" onclick="Caixa.closeSession()" style="height:60px; font-weight:800; font-size:1.1rem;">
                                <i class="ri-lock-2-line"></i> FECHAR CAIXA AGORA
                            </button>
                            <button class="btn btn-secondary btn-sm" onclick="Caixa.printParcial()" style="width:100%;">
                                <i class="ri-printer-line"></i> Imprimir Parcial (X)
                            </button>
                        </div>
                    </div>
                </div>
