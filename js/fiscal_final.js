        ...
        <div id="fiscal-modal" class="modal-overlay" style="display:flex; z-index:9999; align-items:center; justify-content:center;">
            <div class="modal-content" style="max-height:90vh; overflow-y:auto; max-width:600px;">
                ...
                <div class="modal-body">
                    ...
                    <div style="background:#1e293b; border:1px solid #334155; border-radius:12px; padding:20px; margin-bottom:20px; box-shadow: inset 0 2px 4px rgba(0,0,0,0.2);">
                        <h5 style="color:#4ade80; margin-bottom:15px; display:flex; align-items:center; gap:8px; font-size:1.1rem;"><i class="ri-settings-3-line"></i> Credenciais Nuvem Fiscal</h5>
                        ...
                        <div class="input-wrapper" style="margin-top:20px; border-top:1px solid #334155; padding-top:20px;">
                            <label style="color:#94a3b8;">Email do Contador (Para envio de XML)</label>
                            <input type="email" id="cont-email" class="input-field" value="${store.email_contador || ''}" placeholder="contador@escritorio.com" style="background:#0f172a !important;">
                        </div>
                        ...
                        <div style="display:flex; gap:10px; margin-top:15px;">
                            <button class="btn btn-warning" style="flex:1; color:#fff; font-weight:bold; height:50px;" onclick="App.store.showNotasNaoEmitidasModal()">
                                <i class="ri-file-warning-line"></i> NOTAS PENDENTES
                            </button>
                            <button class="btn btn-info" style="flex:1; height:50px;" onclick="Fiscal.exportarXMLs()">
                                <i class="ri-download-cloud-line"></i> BAIXAR XMLs (ZIP)
                            </button>
                        </div>
                    </div>

                    <div style="border-top:1px solid #334155; padding-top:20px;">
                        <h5 style="color:#f87171; margin-bottom:15px; font-size:1.1rem;"><i class="ri-file-warning-line"></i> Cancelar Notas (Últimos 30 min)</h5>
                        <div style="background:#0f172a; border:1px solid #334155; border-radius:12px; overflow:hidden; color:#e2e8f0;">
                            ${notesHtml}
                        </div>
                    </div>
                </div>
