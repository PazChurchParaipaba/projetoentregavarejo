                ...
                <main class="pos-main-sale">
                    <div class="pos-tile" style="padding: 10px 20px;">
                        <div style="display:flex; gap:15px; align-items:center;">
                            ...
                            <input type="text" id="pos-barcode" placeholder="BIPAR PRODUTO OU DIGITAR NOME... (F1)" autocomplete="off" style="flex:1; background:none; border:none; color:#fff; font-size:1.4rem; font-weight:700; outline:none; padding:10px;">
            ...
            try {
                ...
                if (typeof App !== 'undefined' && App.multiOperator && App.multiOperator.logAction) {
                    App.multiOperator.logAction("VENDA_FINALIZADA", { 
                        ...
                        itemsCount: Varejo.state.ticket.length
                    });
                }
