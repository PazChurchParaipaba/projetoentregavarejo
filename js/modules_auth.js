                ...
                if (App.logistics && App.logistics.consultarCep) {
                    ...
                    if (!data.erro) {
                        ...
                        if (prev) {
                            ...
                            prev.innerHTML = `<i class="ri-map-pin-line"></i> ${data.city}/${data.state} - ${data.neighborhood || ''}`;
                ...
                if (role === 'loja_admin') {
                    ...
                    <div class="input-wrapper"><label>CEP da Loja</label>
                        <div style="display:flex; gap:5px;">
                            ...
                            <button class="btn btn-secondary btn-sm" onclick="App.auth.fetchAddress(document.getElementById('reg-cep').value)"><i class="ri-search-line"></i></button>
                        </div>
                    ...
                    <div class="input-wrapper" style="border: 2px dashed var(--primary); padding: 10px; border-radius: 8px; background: var(--info-bg);">
                        <label style="color:var(--primary)"><i class="ri-key-2-line"></i> Token de Autorização</label>
